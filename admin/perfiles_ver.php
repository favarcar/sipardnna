...
<div class="box-header with-border">
                      <h3 class="box-title">Ver perfiles</h3>
                      <a href="main.php?key=110" class="btn btn-primary"><i class="fa fa-arrow-left"></i>Regresar</a>
...
<!--Botones de acción de la página ver conceptos--><br>
   <a href="main.php?key=111&Id=<?php echo $cod_uso ?>" class="btn btn-warning"><i class="fa fa-edit"></i> Editar</a>
