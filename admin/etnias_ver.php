...
<div class="box-header with-border">
                      <h3 class="box-title">Ver Etnias</h3>
                      <a href="main.php?key=75" class="btn btn-primary"><i class="fa fa-arrow-left"></i>Regresar</a>
...
<!--Botones de acción de la página ver conceptos-->
   <a href="main.php?key=76&Id=<?php echo $cod_uso ?>" class="btn btn-warning"><i class="fa fa-edit"></i> Editar</a>
