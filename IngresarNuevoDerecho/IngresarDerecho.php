...
?>
    ...
    <div class="container pi3x">
          ...
          <form class="form-horizontal ps2x"  method="post" enctype="multipart/form-data" >
                ...
                <!-- Form Name -->
                 <h3 class="centrar letra n600 azulo pi">Registrar Nuevo Derecho</h3>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-4">
                  <input id="textinput" name="descripcion" type="text" placeholder="" class="form-control input-md" onkeyup = "this.value=this.value.toUpperCase()" required >
...
if($_POST){ //si se ha presionado enviar
   ...
   $descripcion=$_POST['descripcion'];
	...
	$sql ="INSERT INTO `derechos` value('$id_derecho','$descripcion')";
