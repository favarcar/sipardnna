                                ...
                                ?>
                                        <tr>
                                            ...
                                            <td align="center">
                                                <?php echo $edad;  ?></td>
                                            <td align="center">
                                                <h5 class="letra n500  azulo centrar ps linku "><a href="ModificarNNA.php?id_ninnos=<?php echo $row['id_ninnos']; ?>" class="linku">Consultar</a></h5>
                                            </td>
                                            <td align="center">
                        ...
                        <section class="fblanco">
                            <div class="container pu pi">
                                ...
                                <div class="table-responsive">
                                    <table width="1166" border="1" id="tab" style="background:#FFFFFF" align="center" class="table">
                                        <tr>
                                            <td colspan="11" class="letra n600 azulo">Total Ni&ntilde;os, Ni&ntilde;as Adolecentes Registrados: <?php
                                                                                                                                                $con4 = mysqli_query($con, "SELECT count(id_ninnos) FROM ninnosnna where id_usuario='$id_usuario'");
    ...
    <footer class="f4 borde_top">
        <div class="container">
            <div class="row clearfix pi2x ps">
                <div>
                    <img class="img-responsive  center-block  borde_blanco " src="../img/secretaria_integracion.png" width="60%" alt="" />
                </div>
                <div align="center">
