            ...
            <form class="form-horizontal ps2x" method="post" enctype="multipart/form-data">
                <fieldset>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <input id="textinput" name="sisben_nna" type="text" placeholder="Categorías [A1-A5] [B1-B7] [C1-C18] [D1-D21]" class="form-control input-md" value="<?php echo $Puntaje_Sisben ?>" required>
