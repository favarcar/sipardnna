           ...
           <div class="container">
                            ...
                            <div class="row clearfix ps pi">
                              <div class="col-md-3 col-sm-3 ps pi">
                                 <a href="MenuInvitado/MenuNinosNinasAdo.php"><img src="iconos/ninos.png" alt="..." width="150" height="150" class="center-block"></a>
                               <h4 class="centrar letra azulo n400 ps"><strong>Consultar Ni&ntilde;os, Ni&ntilde;as o Adolescentes</strong></h4>
                              </div>
                                
                                <div class="col-md-3 col-sm-3 ps pi">
                                 <a href="MenuInvitado/MenuMPC.php"><img src="iconos/padres.png" alt="..." width="150" height="150" class="center-block"></a>
                               <h4 class="centrar letra azulo n400 ps"><strong>Consultar Madres, Padres o Cuidadores</strong></h4>
                                ...
                                <div class="col-md-3 col-sm-3 ps pi">
                                    <a href="MenuInvitado/MenuExpediente.php"><img src="iconos/expe.png" alt="..." width="150" height="150" class="center-block"></a>
                                    <h4 class="centrar letra azulo n400 ps"><strong>Consultar Expedientes </strong></h4>
                                </div>
                                
                                <div class="col-md-3 col-sm-3 ps pi">
                                    <a href="MenuInvitado/MenuMiUsuario.php"><img src="iconos/usuario.png" alt="..." width="150" height="150" class="center-block"></a>
