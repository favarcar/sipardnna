                ...
                ?>    
                    <div class="table-responsive"> 
                        <table class="table table-striped table-bordered">
                            <tr>
                                <td colspan="10" class="letra n600 azulo" bgcolor="#ff9933">Total Usuarios Autorizados:
                                <?php
                                    $con4 = mysqli_query($con,"SELECT COUNT(id_usuario) FROM usuarios WHERE estado = 1");			
                ...
                <div class="container pu pi">
                    <div class="table-responsive"> 
                        <table class="table table-striped table-bordered">
                            ...
                            <tbody>
                            <?php
                                $busqueda = mysqli_query($con,"SELECT * FROM usuarios where ESTADO = 1 order by apellidos ");//cambiar nombre de la tabla de busqueda
                                while($row = mysqli_fetch_array($busqueda)){			
