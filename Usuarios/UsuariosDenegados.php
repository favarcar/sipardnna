...
<html class="no-js" lang="">
    ...
    <body class="fblanco">
        ...
        <form name="form1" method="post" action="UsuariosDenegados.php" id="cdr" >
            <center>
                <h3 class="centrar letra n600 azulo pi">Usuarios Denegados</h3>               
                <br>
                ...
                ?>                                 
                    <div class="table-responsive"> 
                        <table class="table table-striped table-bordered">
                            <tr>
                                <td colspan="10" class="letra n600 azulo" bgcolor="#ff9933">Total Usuarios Denegados: 
                                <?php 
                            ...
                            <?php
                                ...
                                $busca = $_POST['busca'];
                                if($busca != ""){
                                    $busqueda = mysqli_query($con,"SELECT * FROM usuarios WHERE estado = 0 AND apellidos LIKE '%".$busca."%' OR numero_documento LIKE '%".$busca."%' AND estado = 0");//cambiar nombre de la tabla de busqueda
                            ...
                            ?>				
                                <tr>                       
                                    ...
                                    <td align="center"><h5 class="letra n500  azulo centrar ps linku "><a href="EliminarUsuarioRegistrado.php?id_usuario=<?php echo $row['id_usuario'];?>" class="linku">Eliminar</a></h5></td>
                                <?php 
                                    } 
                                }
                                ?>
                ...
                <div class="container pu pi">                                                                      
                    <div class="table-responsive"> 
                        <table class="table table-striped table-bordered">
                            ...
                            <tbody>
                            <?php
                                $busqueda = mysqli_query($con,"SELECT * FROM usuarios WHERE estado = 0 ORDER BY apellidos ");//cambiar nombre de la tabla de busqueda
                                while($row = mysqli_fetch_array($busqueda)){						
