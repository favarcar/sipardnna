...
if($busca!=""){
$busqueda=mysql_query("SELECT * FROM ninnosnna where Apellidos LIKE '%".$busca."%' OR No_identificacion LIKE '%".$busca."%' and  id_usuario='$id_usuario'");//cambiar nombre de la tabla de busqueda
while($row=mysql_fetch_array($busqueda)){
    ...
    ?>  				
          ...
          <?php echo $edad;  ?></td>  
           ...
           $busqueda21=mysql_query("SELECT * FROM cuidadores where 	id_ninos='$id_ninos'  ");
		   ...
		   if($id_ninos==$id_ninos21){ ?>
            ...
            <td align="center"><h5 class="letra n500  azulo centrar ps linku "><a href="ConsultarRegistrosMPC.php?id_ninnos=<?php echo $row['id_ninnos'];?>" class="linku">Consultar</a></h5></td>
...
$busqueda=mysql_query("SELECT * FROM ninnosnna where id_usuario='$id_usuario' order by id_ninnos  desc ");//cambiar nombre de la tabla de busqueda
while($row=mysql_fetch_array($busqueda)){
