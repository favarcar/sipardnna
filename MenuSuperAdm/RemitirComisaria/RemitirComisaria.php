...
if($busca!=""){
$busqueda=mysql_query("SELECT * FROM usuarios where id_perfil = 6 and apellidos LIKE '%".$busca."%' OR numero_documento LIKE '%".$busca."%'");//cambiar nombre de la tabla de busqueda
...
$busqueda=mysql_query("SELECT * FROM usuarios where id_perfil = 6  order by apellidos ");//cambiar nombre de la tabla de busqueda
while($row=mysql_fetch_array($busqueda)){
