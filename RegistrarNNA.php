<script>
    ...
    while ($row = mysqli_fetch_array($ingresar_mpc)) {
        ...
        $Nombres_cuidadores = $row['Nombres_cuidadores'];
        $Apellidos_cuidadores = $row['Apellidos_cuidadores'];
            ...
            <div class="panel-group">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <label class="col-md-4 control-label letra n600 azulo" for="textinput">Nombre M.P.C.</label>
                        <div class="col-md-8">
                            <input id="textinput" name="nom_nna" type="text" placeholder="" class="form-control input-md" style="text-transform: uppercase;" onkeyup="this.value=this.value.toUpperCase()" value="<?php echo $Apellidos_cuidadores;  ?> <?php echo $Nombres_cuidadores; ?>" readonly>
                        </div>
                    </div>
                    <div class="col-md-6 col-sm-4 col-xs-12 form-group">
                        <label for="textinput">N. Documento M.P.C.</label>
                            <input id="textinput" name="num_nna" type="text" placeholder="" class="form-control input-md" style="text-transform: uppercase;" onkeypress="return numeros(event)" value="<?php echo $No_Cedula; ?>" readonly>
                        </div>
                    </div>
                                    <br>
                                    <br>
                    ...
                    <div class="panel-body" >
                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="col-md-6 col-sm-4 col-xs-12 form-group">
                                    <label>Nombres</label>
                                    <input id='nom_nna' name='nom_nna' class="form-control" placeholder="Ingrese el nombre completo del niño(a) ó adolescente" style="text-transform: uppercase;" required>
                                    <!--<p class="help-block">Example block-level help text here.</p> -->
                                </div>
                                <div class="col-md-6 col-sm-4 col-xs-12 form-group">
                                ...
                                <div class="col-md-4 col-sm-4 col-xs-12 form-group">
                                    ...
                                    <input id='telefono_nna' type="int" minlength="10" maxlength="10" name='telefono_nna' class="form-control" placeholder="Ingrese el número telefónico" required>
                                    <!--<p class="help-block">Example block-level help text here.</p> -->
                                </div>
                                    </select>
                                </div>
