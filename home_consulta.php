...
<div class="row clearfix ps pi">
      ...
      <a href="main.php?key=1"><img src="iconos/ninos2.png" alt="..." width="100" height="100" class="center-block pic"></a>
	  ...
	  <div class="col-lg-3">
      <div class="col-md-12 col-sm-12 ps pi">
      <a href="main.php?key=16"><img src="iconos/expe2.png" alt="..." width="100" height="100" class="center-block pic"></a>
