...
<body style="background-color: #64AF59;">
            ...
            <div class="row clearfix centrar">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 ">
                    <ul class="nav nav-tabs">
                        ...
                        <li role="presentation" class="letra n500"><a href="../MenuAdministrador/ConsultarMPC.php" target="usuario">Consultar MPC</a></li>
    ...
    <iframe name="usuario" src="../MenuAdministrador/ConsultarMPC.php" width="100%" height="0" frameborder="0" transparency="transparency" onload="autofitIframea(this);" scrolling="no"></iframe>
