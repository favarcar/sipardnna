             ...
             <div class="container ps ">
               <div class="row clearfix centrar">
                 <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 ">
                   <h2 class=" letra n600 azulo pi"><h5 class="letra n500  azulo " align="right"><a href="ExportarPDF.php?codigo_expediente=<?php echo $row50['codigo_expediente'];?>" class=" btn btn-primary">Exportar PDF</a></h5>	</h2>
                 </div>
                </div>        
               </div>        
       </section>	
