...
<section class="fblanco" style="background-image: url(img/SIPARDNNA.png);
	...
	background-attachment:fixed; ">
        ...
        <table border="1" style="background:#FFFFFF" align="center" width="95%" class="table">
            ...
            <tr>
             <td class="centrar letra n600 azulo pi" >No.</td>
                ...
                <td class="centrar letra n600 azulo pi">Veredicto del Caso </td>
        ...
        $sql="select * from expediente where id_usuario_exp='$id_usuario'";
		$resultado=$mysqli->query($sql); 
            ...
            while($datos=$resultado->fetch_assoc()){
                ...
                if($fecha == $fecha_limite || $id_estadocaso == 2 ){} else{    
                
					?>
            <tr>
             <td align="center" ><?php  echo $codigo_expediente ?></td>
                <td><?php echo $Fecha_inicio_expediente ?></td>
                <td align="center"><?php echo $Descripcion_expediente ?></td>
                
               
                <td align="center"><?php echo $Veredicto_Caso ?> </td>
                <td align="center"><?php                     
...
?></td>
                <td align="center"><h5 class="letra n500  azulo centrar ps linku "><a href="MenuJuezfamilia/ModificarExpedienteNoti.php?codigo_expediente=<?php echo $datos['codigo_expediente'];?>&id_ninnos=<?php echo $datos['id_ninnos'];?>" class="linku">Ver</a></h5></td>
            </tr>
          ...
          <?php } } ?>
                            ...
                            <div class="row clearfix ps pi">
                              <div class="col-md-3 col-sm-3 ps pi">
                                  <a href="MenuJuezfamilia/MenuNinosNinasAdo.php"><img src="iconos/ninos.png" alt="..." width="150" height="150" class="center-block"></a>
                                <h4 class="centrar letra azulo n400 ps"><strong><b>Ingresar Ni&ntilde;os, Ni&ntilde;as o Adolescentes</b></strong></h4>
                              </div>
                                
                               <div class="col-md-3 col-sm-3 ps pi">
                                    <a href="MenuJuezfamilia/MenuMPC.php"><img src="iconos/padres.png" alt="..." width="150" height="150" class="center-block"></a>
                                ...
                                <div class="col-md-3 col-sm-3 ps pi">
                                    <a href="MenuJuezfamilia/MenuExpediente.php"><img src="iconos/expe.png" alt="..." width="150" height="150" class="center-block"></a>
                                    <h4 class="centrar letra azulo n400 ps"><strong>Expedientes </strong></h4>
                                </div>
                                <div class="col-md-3 col-sm-3 ps pi">
                                    <a href="MenuJuezfamilia/MenuDerecho.php"><img src="iconos/derecho.png" alt="..." width="150" height="150" class="center-block"></a>
                                  <h4 class="centrar letra azulo n400 ps"><strong>Derechos</strong></h4>
                                </div>
                                
                                 <div class="col-md-3 col-sm-3 ps pi">
                                    <a href="MenuJuezfamilia/MenuMiUsuario.php"><img src="iconos/usuario.png" alt="..." width="150" height="150" class="center-block"></a>
