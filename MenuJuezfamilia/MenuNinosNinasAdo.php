             ...
             <div class="container ps ">
               <div class="row clearfix centrar">
                 <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 ">
                   <h2 class="centrar letra n600 azulo pi">Ni&ntilde;os, Ni&ntilde;as o Adolescentes NNA</h2>
                 </div>
                </div>        
               </div>        
       </section>
              ...
              <div class="row clearfix centrar">
               <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 ">                  
                <ul class="nav nav-tabs">
                 ...
                 <li role="presentation" class="letra n500"><a href="../NNA/IngresarNNA.php" target="usuario">Registrar NNA</a></li>
                 <li role="presentation" class="letra n500"><a href="../NNA/ConsultarNNA.php" target="usuario">Consultar NNA</a></li>
...
<iframe name="usuario" src="../NNA/IngresarNNA.php" width="100%"   height="0" frameborder="0" transparency="transparency" onload="autofitIframea(this);" scrolling="no"></iframe>
