              ...
              <div class="row clearfix centrar">
               <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 ">                  
                <ul class="nav nav-tabs">
                 ...
                 <li role="presentation" class="letra n500"><a href="../Expediente/TotalExpedientes/ConsultarTotalExpediente.php" target="usuario">Consultar Total de Expedientes</a></li>
