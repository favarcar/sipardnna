...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 17-11-2022 a las 15:47:10
...
(80, 85, '2022-11-09', 'Psicologo', 'Matrato psicologico', 'Matrato psicologico'),
(81, 86, '2022-11-17', 'Comisario', 'ggg', 'ggg'),
(82, 87, '0000-00-00', '', '', ''),
(83, 88, '0000-00-00', '', '', ''),
(84, 89, '2022-11-16', 'Maltrato psicosocial', 'Maltrato psicosocial', 'Maltrato psicosocial'),
(85, 90, '2022-11-21', 'SSS', 'SSSSSSSSSSS', 'SSSSSSSSSSSSSS'),
(86, 91, '2022-11-16', 'WWW', 'WW', 'WWW'),
(87, 92, '2022-11-22', 'aaa', 'aaaa', 'aa');
...
CREATE TABLE IF NOT EXISTS `expediente` (
  ...
  `Descripcion_expediente` varchar(600) DEFAULT NULL,
  `funcionario_actuacion_exp` varchar(30) NOT NULL,
  `concepto_verificacion` varchar(600) NOT NULL,
  `concepto_psicologico` varchar(600) NOT NULL,
  `concepto_social` varchar(600) NOT NULL,
  `juzgamiento` text NOT NULL,
  `id_derecho` varchar(7) DEFAULT NULL,
  `Observacion` varchar(600) DEFAULT NULL,
  `Veredicto_Caso` varchar(600) DEFAULT NULL,
...
INSERT INTO `expediente` (`codigo_expediente`, `NUMERO_PROCESO`, `Fecha_inicio_expediente`, `id_ninnos`, `id_cuidadores`, `id_discapacidad`, `id_indicador`, `id_maltrato`, `id_victima`, `Descripcion_expediente`, `funcionario_actuacion_exp`, `concepto_verificacion`, `concepto_psicologico`, `concepto_social`, `juzgamiento`, `id_derecho`, `Observacion`, `Veredicto_Caso`, `Fecha_finalizacion_expediente`, `id_entidad`, `id_usuario_exp`, `id_estadocaso`, `fecha_limite`) VALUES
...
(85, '1112022', '2022-11-01', 30, 30, 1, 2, 1, 2, 'Matrato psicologico', 'Psicologo', 'Matrato psicologico', '', '', 'Amenaza', '2', 'Matrato psicologico ffggg ohoihijmnnin', 'Requiere Pard tahjj', '2022-11-16', '20', 1057578145, 1, '2023-03-01'),
(86, '7777777777', '2022-11-03', 30, 30, 3, 5, 4, 3, 'ddddd', 'Comisario', 'fffff', '', '', 'Vulneración', '7', 'ddd', 'No Requiere Pard', '2022-11-16', '18', 42101110, 1, '2023-03-03'),
(87, '3333', '2022-11-03', 30, 30, 1, 0, 0, 0, 'ff', '', '', '', '', '', '', 'ff', 'No Requiere Pard', '2022-11-24', '', 1057578145, 0, '2023-03-03'),
(88, '451515', '2022-11-03', 30, 30, 4, 0, 0, 0, 'dgsdg', '', '', '', '', '', '', 'sgdgddgs', 'No Requiere Pard', '2022-11-24', '', 1057578145, 0, '2023-03-03'),
(89, '4566546', '2022-11-03', 30, 30, 6, 1, 3, 2, 'Maltrato psicosocial', 'COMISARIA Y PSICOLOGA  ', 'Contador de palabras y contador de caracteres es una herramienta que te permite contar la cantidad de palabras o de caracteres que posee un texto. Simplemente, debes posicionar el cursor dentro de la ventana y comenzar a escribir con el teclado. El sistema contará automáticamente la cantidad de palabras y caracteres que has ingresado. También es posible copiar y pegar un texto que hayas escrito fuera del sistema; automáticamente mostrará el recuento de palabras y caracteres del texto copiado.', 'Contador de palabras y contador de caracteres es una herramienta que te permite contar la cantidad de palabras o de caracteres que posee un texto. Simplemente, debes posicionar el cursor dentro de la ventana y comenzar a escribir con el teclado. El sistema contará automáticamente la cantidad de palabras y caracteres que has ingresado. También es posible copiar y pegar un texto que hayas escrito fuera del sistema; automáticamente mostrará el recuento de palabras y caracteres del texto copiado.', 'Contador de palabras y contador de caracteres es una herramienta que te permite contar la cantidad de palabras o de caracteres que posee un texto. Simplemente, debes posicionar el cursor dentro de la ventana y comenzar a escribir con el teclado. El sistema contará automáticamente la cantidad de palabras y caracteres que has ingresado. También es posible copiar y pegar un texto que hayas escrito fuera del sistema; automáticamente mostrará el recuento de palabras y caracteres del texto copiado.', 'Amenaza', '4', 'Maltrato psicosocial', 'Requiere Pard', '2022-11-24', '8', 1057578145, 3, '2023-03-03'),
(90, '546494', '2022-11-11', 6, 0, 6, 2, 6, 6, 'NA', 'SSS', '                                          <textarea id="concepto_psicologico" class="form-control" name="concepto_psicologico" style=" resize: none;" cols="40" data-parsley-trigger="keyup" data-parsley-minlength="20" data-parsley-maxlength="500" data-parsley-minlength-message="Escribir como mínimo 20 letras ..." data-parsley-validation-threshold="10" placeholder="Escriba su nombre, número de cédula, número de tarjeta profesional y el concepto de verificaci&oacute;n"></textarea>\n                                    </div>\n\n                                    <div class="col-md-6 col-sm-4 col-', '                                        <textarea id="concepto_psicologico" class="form-control" name="concepto_psicologico" style=" resize: none;" cols="40" data-parsley-trigger="keyup" data-parsley-minlength="20" data-parsley-maxlength="500" data-parsley-minlength-message="Escribir como mínimo 20 letras ..." data-parsley-validation-threshold="10" placeholder="Escriba su nombre, número de cédula, número de tarjeta profesional y el concepto de verificaci&oacute;n"></textarea>\n                                    </div>\n\n                                    <div class="col-md-6 col-sm-4 col-xs', '                                        <textarea id="concepto_psicologico" class="form-control" name="concepto_psicologico" style=" resize: none;" cols="40" data-parsley-trigger="keyup" data-parsley-minlength="20" data-parsley-maxlength="500" data-parsley-minlength-message="Escribir como mínimo 20 letras ..." data-parsley-validation-threshold="10" placeholder="Escriba su nombre, número de cédula, número de tarjeta profesional y el concepto de verificaci&oacute;n"></textarea>\n                                    </div>\n\n                                    <div class="col-md-6 col-sm-4 col-xs', 'Amenaza', '19', 'NA', 'Requiere Pard', '2022-11-22', '13', 1057578145, 1, '2023-03-11'),
(91, '15551551', '2022-11-11', 6, 0, 5, 2, 8, 6, '4444', 'WWW ', 'Se puede decir que 500 palabrasson, aproximadamente, dos cuartillas. Una cuartilla, considerando parámetros estándar, se encuentra conformada entre200 y 250 palabras. Por tanto, 500 palabras sería, aproximadamente, dos cuartillas. Una cuartilla tiene aproximadamente 26-27 renglones, además, las medidas de esta son 14,8 x 21 cm.', 'Se puede decir que 500 palabrasson, aproximadamente, dos cuartillas. Una cuartilla, considerando parámetros estándar, se encuentra conformada entre200 y 250 palabras. Por tanto, 500 palabras sería, aproximadamente, dos cuartillas. Una cuartilla tiene aproximadamente 26-27 renglones, además, las medidas de esta son 14,8 x 21 cm.', 'Se puede decir que 500 palabrasson, aproximadamente, dos cuartillas. Una cuartilla, considerando parámetros estándar, se encuentra conformada entre200 y 250 palabras. Por tanto, 500 palabras sería, aproximadamente, dos cuartillas. Una cuartilla tiene aproximadamente 26-27 renglones, además, las medidas de esta son 14,8 x 21 cm.', 'Amenaza', '6', '4484894', 'Requiere Pard', '2022-11-16', '17', 1057578145, 1, '2023-03-11'),
(92, '5545854', '2022-11-11', 6, 0, 4, 1, 3, 1, 'maltrato', 'COMISARIO', 'Se puede decir que 500 palabrasson, aproximadamente, dos cuartillas. Una cuartilla, considerando parámetros estándar, se encuentra conformada entre200 y 250 palabras. Por tanto, 500 palabras sería, aproximadamente, dos cuartillas. Una cuartilla tiene aproximadamente 26-27 renglones, además, las medidas de esta son 14,8 x 21 cm.', 'Se puede decir que 500 palabrasson, aproximadamente, dos cuartillas. Una cuartilla, considerando parámetros estándar, se encuentra conformada entre200 y 250 palabras. Por tanto, 500 palabras sería, aproximadamente, dos cuartillas. Una cuartilla tiene aproximadamente 26-27 renglones, además, las medidas de esta son 14,8 x 21 cm.', 'Se puede decir que 500 palabrasson, aproximadamente, dos cuartillas. Una cuartilla, considerando parámetros estándar, se encuentra conformada entre200 y 250 palabras. Por tanto, 500 palabras sería, aproximadamente, dos cuartillas. Una cuartilla tiene aproximadamente 26-27 renglones, además, las medidas de esta son 14,8 x 21 cm.', 'Amenaza', '5', 'dddddd', 'Requiere Pard', '2022-12-01', '15', 1057578145, 1, '2023-03-11');
...
(46, '', '', 78, 4, '', 0, '', '', 0, '', ''),
(47, 'SI', '', 79, 4, '', 0, '', '', 0, '', ''),
(48, 'SI', 'CUIDADOR', 80, 30, 'CC', 999999999, 'martin', 'Noa', 45, 'EDU_INI', '3122588989'),
(49, 'NO', '', 81, 30, '', 0, '', '', 0, '', ''),
(50, '', '', 82, 30, '', 0, '', '', 0, '', ''),
(51, '', '', 83, 30, '', 0, '', '', 0, '', ''),
(52, 'SI', '', 84, 30, '', 0, '', '', 0, '', ''),
...
(752, 137, '2022-10-20 05:00:00', '10:10:10'),
(753, 137, '2022-10-20 05:00:00', '10:10:10'),
(754, 137, '2022-10-20 05:00:00', '10:10:10'),
(755, 137, '2022-10-28 05:00:00', '10:10:10'),
(756, 137, '2022-11-01 05:00:00', '14:11:11'),
(757, 137, '2022-11-02 05:00:00', '09:11:11'),
(758, 137, '2022-11-02 05:00:00', '16:11:11'),
(759, 137, '2022-11-03 05:00:00', '08:11:11'),
(760, 6, '2022-11-03 05:00:00', '11:11:11'),
(761, 137, '2022-11-03 05:00:00', '14:11:11'),
(762, 137, '2022-11-04 05:00:00', '08:11:11'),
(763, 137, '2022-11-04 05:00:00', '08:11:11'),
(764, 137, '2022-11-09 05:00:00', '10:11:11'),
(765, 137, '2022-11-09 05:00:00', '17:11:11'),
(766, 137, '2022-11-09 05:00:00', '17:11:11'),
(767, 137, '2022-11-09 05:00:00', '17:11:11'),
(768, 137, '2022-11-11 05:00:00', '14:11:11'),
(769, 137, '2022-11-12 05:00:00', '12:11:11'),
(770, 137, '2022-11-15 05:00:00', '16:11:11'),
(771, 137, '2022-11-16 05:00:00', '14:11:11'),
(772, 137, '2022-11-17 05:00:00', '09:11:11'),
(773, 137, '2022-11-17 05:00:00', '09:11:11');
...
(2, 'EDU_INI', 'EDUCACION INICIAL'),
(3, 'BASICA_PRI', 'BASICA PRIMARIA'),
(4, 'BASICA_SECU', 'BASICA SECUNDARIA'),
(5, 'MEDIA', 'MEDIA ACADEMICA/TECNICA'),
(6, 'PREGRADO', 'PREGRADO'),
(7, 'POSTGRADO', 'POSTGRADO'),
(8, 'MAESTRIA', 'MAESTRIA');
