...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 04-11-2022 a las 16:46:07
...
CREATE TABLE IF NOT EXISTS `expediente` (
  ...
  `concepto_verificacion` varchar(200) NOT NULL,
  `concepto_psicologico` varchar(200) NOT NULL,
  `concepto_social` varchar(200) NOT NULL,
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=764 ;
