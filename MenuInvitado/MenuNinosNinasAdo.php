        ...
        <div class="container">
            <div class="row clearfix ps pi2x">
                ...
                <div class="col-xs-12 col-sm-4 col-md-3 col-lg-3 ps pi linku">
                    <h3 class="centrar letra azulo n400"><strong>Bienvenido Invitado</strong></h3>
            ...
            <div class="row clearfix centrar">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 ">
                    <ul class="nav nav-tabs">
                        <li role="presentation" class="letra n500"><a href="../MenuInvitado.php">Volver Men&uacute; Principal</a></li>
