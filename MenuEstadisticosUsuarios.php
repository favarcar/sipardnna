...
<body style="background-color: #64AF59;">
        ...
        <div class="container ps">
            <div class="row clearfix centrar">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 ">
                    <h2 class="centrar letra n600 azulo pi">Consultar Ingresos al Sistema</h2>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row clearfix centrar">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 ">
                    <ul class="nav nav-tabs">
                        ...
                        <li role="presentation" class="letra n500"><a href="EstaditicosUsuarios/UsuariosAutorizados.php" target="usuario">Consultar Ingresos al Sistema</a></li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <iframe name="usuario" src="EstaditicosUsuarios/UsuariosAutorizados.php" width="100%" height="0" frameborder="0" transparency="transparency" onload="autofitIframea(this);" scrolling="no"></iframe>
