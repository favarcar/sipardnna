...
<body>
    ...
    <iframe name="usuario" src="ConsultarExpedientesNinos.php?id_ninnos=<?php echo $_REQUEST['id_ninnos'] ?>" width="100%" height="0" frameborder="0" transparency="transparency" onload="autofitIframea(this);" scrolling="no"></iframe>
