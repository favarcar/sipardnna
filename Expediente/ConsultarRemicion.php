  ...
  <section class="fblanco">
    <div class="container pi3x">
          ...
          <div class="form-group">
            ...
            <div class="col-md-4">
              <select name="cargo_usu" id="cargo_usu" disabled class="form-control" style="text-transform: uppercase;">
                ...
                <?php
                $con11 = mysqli_query($con, "select * from perfiles");
                $reg11 = mysqli_fetch_array($con11);
                do {
                  $id_car = $reg11['id_perfil'];
                  $des_cam = $reg11['descripcion'];
                ?>
      ...
      if ($_POST) {
        ...
        mysqli_query($con, "DELETE FROM remite WHERE id_remite='$id_remite'") or die(mysqli_error($con));
