...
<head>
  ...
  <title>Sistema de informción</title>
      ...
      <form class="form-horizontal ps2x" method="post" enctype="multipart/form-data">
        <fieldset>
          ...
          <div class="form-group">
            ...
            <div class="col-md-4">
              <input id="textinput" name="cod_exp" type="text" placeholder="" class="form-control input-md" value="<?php echo $codigo_expediente ?>" readonly>
          ...
          <div class="form-group">
            ...
            <div class="col-md-4">
              ...
              ?>
              <select name="discapacidad_exp" id="discapacidad_exp" required class="form-control" style="text-transform: uppercase;">
                <option value="<?php echo $id_discapacidad ?>"><?php echo $des_discapacidad ?></option>
                <?php
                $con111 = mysqli_query($con, "select * from  discapacidades");
                $reg111 = mysqli_fetch_array($con111);
                do {
                  $id_discapacidad111 = $reg111['id_discapacidad'];
                  $des_discapacidad111 = $reg111['descripcion_discapacidades'];
                ?>
                  <option value="<?php echo $id_discapacidad111; ?>"><?php echo $des_discapacidad111; ?> </option>
                <?php
                } while ($reg111 = mysqli_fetch_array($con111));
                ?>
          ...
          <div class="form-group">
            ...
            <div class="col-md-4">              
              ...
              ?>
              <select name="indicadores_exp" id="discapacidad_exp" required class="form-control" style="text-transform: uppercase;">
                <option value="<?php echo $id_indicador ?>"><?php echo $des_indicador ?></option>
                <?php
                $con2 = mysqli_query($con, "select * from  indicadores");
                $reg = mysqli_fetch_array($con2);
                do {
                  $id_indicador = $reg['id_indicador'];
                  $des_indicador = $reg['descripcion_indicadores'];
                ?>
                  <option value="<?php echo $id_indicador; ?>"><?php echo $des_indicador; ?> </option>
                <?php
          ...
          <div class="form-group">
            ...
            <div class="col-md-4">
              ...
              <select name="maltratos_exp" id="maltratos_exp" required class="form-control" style="text-transform: uppercase;">
                ...
                do {
                  $id_maltrato = $reg22['id_maltrato'];
                  $des_maltrato = $reg22['descripcion_maltratos'];
                ?>
                  <option value="<?php echo $id_maltrato; ?>"><?php echo $des_maltrato; ?> </option>
                <?php
          ...
          <div class="form-group">
            ...
            <div class="col-md-4">
              ...
              <?php $busqueda1 = mysqli_query($con, "SELECT * FROM victimas where id_victima='$id_victima' ");
              while ($row1 = mysqli_fetch_array($busqueda1)) {
              ...
              <select name="victima_exp" id="victima_exp" required class="form-control" style="text-transform: uppercase;">
                <option value="<?php echo  $id_victima  ?>"><?php echo  $des_victima  ?></option>
                <?php
                $con3 = mysqli_query($con, "select * from  victimas");
          ...
          <div class="form-group">
            ...
            <div class="col-md-4">
              ...
              while ($row11 = mysqli_fetch_array($busqueda11)) {
                ...
                $id_entidad = $row11['id_entidad'];
                $des_entidad = $row11['descripcion_entidades'];
              }
              ?>
              ...
              <select name="entidad_exp" id="entidad_exp" required class="form-control" style="text-transform: uppercase;">
                ...
                <?php
                $con44 = mysqli_query($con, "select * from  entidades");
                $reg44 = mysqli_fetch_array($con44);
                do {
                  $id_entidad = $reg44['id_entidad'];
                  $des_entidad = $reg44['descripcion_entidades'];
                ?>
                  <option value="<?php echo $id_entidad; ?>"><?php echo $des_entidad; ?> </option>
                <?php
