          ...
          <div class="table-responsive">
            <table width="1166" border="1" id="tab" style="background:#FFFFFF" align="center" class="table">
              ...
              <tbody>
                ...
                if ($busca != "") {
                  $busqueda = mysqli_query($con, "SELECT * FROM usuarios where id_perfil = 4 and apellidos LIKE '%" . $busca . "%' OR numero_documento LIKE '%" . $busca . "%'"); //cambiar nombre de la tabla de busqueda
                ...
                <div class="table-responsive">
                  <table width="1166" border="1" id="tab" style="background:#FFFFFF" align="center" class="table">
                    ...
                    <tbody>
                      ...
                      $busqueda = mysqli_query($con, "SELECT * FROM usuarios where id_perfil = 4  order by apellidos "); //cambiar nombre de la tabla de busqueda
                      while ($row = mysqli_fetch_array($busqueda)) {
