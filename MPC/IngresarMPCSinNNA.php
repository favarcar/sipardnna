...
<body>
    <!--[if lt IE 8]>
        ...
        <h2 class="centrar letra n600 azulo pi">Registrar Formulario Madres, Padres o Cuidadores</h2>
            ...
            <div class="row clearfix centrar">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 ">
                    <ul class="nav nav-tabs">
                        ...
                        <li role="presentation" class="letra n500"><a href="main.php?key=42">Consultar MPC</a></li>
