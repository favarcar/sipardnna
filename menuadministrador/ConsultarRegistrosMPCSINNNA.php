    ...
    <?php
    $id_cuida = $_GET['id_cuidadores'];

      //Traemos los datos de la base de datos de la tabla cuidadores para mostrar el documento en la consulta 
    $busqueda1 = mysqli_query($con, "SELECT * FROM cuidadores WHERE id_cuidadores = '$id_cuida' "); //cambiar nombre de la tabla de busqueda
