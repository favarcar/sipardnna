   ...
   <h1><b>Sistema de Informaci&oacute;n para el Restablecimiento de Derechos de Ni&ntilde;os, Ni&ntilde;as y Adolescentes</b></h1></div>
                  ...
                  <div class="col-xs-12 col-sm-4 col-md-3 col-lg-3 ps pi">
                   ...
                   <div class="col-xs-12 col-sm-4 col-md-3 col-lg-3 ps pi linku">
                     <h3 class="centrar letra azulo n400"><strong>Bienvenido Administrador</strong></h3>
             ...
             <div class="container ps ">
               <div class="row clearfix centrar">
                 <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 ">
                   <h2 class="centrar letra n600 azulo pi">Mi Usuarios</h2>
                 </div>
                </div>        
               </div>        
       </section>
              ...
              <div class="row clearfix centrar">
               <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 ">                  
                <ul class="nav nav-tabs">
                 <li role="presentation" class="letra n500"><a href="../MenuAdministrador.php">Volver Men&uacute; Principal</a></li>
                 <li role="presentation" class="letra n500"><a href="../Usuarios/ModificarUsuario.php" target="usuario">Modificar Usuario</a></li>
                  </ul>
               </div>
              </div>        
             </div>             
...
<iframe name="usuario" src="../Usuarios/ModificarUsuario.php" width="100%"   height="0" frameborder="0" transparency="transparency" onload="autofitIframea(this);" scrolling="no"></iframe>
...
<footer class="f4 borde_top">
            <div class="container">
                      ...
                      <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4  centrar linku">
                          <img class="img-responsive  center-block  borde_blanco "  src="../img/logo SIS_02.png" width="60%" alt=""/>
                      </div>
                      <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4  ">
                          <img class="../img-responsive  center-block  borde_blanco "  src="../img/Logo Avanza_02.png" width="60%" alt=""/>               
                      </div>
                       <div  align="center">             
