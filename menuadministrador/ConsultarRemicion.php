...
include("../conexion/conexion.php");
	...
	<?php 
	$busqueda50=mysql_query("SELECT * FROM remite where codigo_expediente='$codigo_expediente' ");//cambiar nombre de la tabla de busqueda
...
while($row1=mysql_fetch_array($busqueda1)){
 ...
 ?>            
	  ...
	  ?>
               ...
               <?php 
			   if($_POST){ 
                $con1=mysql_query("DELETE FROM remite WHERE id_remite='$id_remite'")or die (mysql_error());
