...
<body style="background-color: #64AF59;">
            ...
            <div class="row clearfix ps pi2x">
                <div class="col-xs-12 col-sm-4 col-md-6 col-lg-6">
                    ...
                    <div align="center" class="letra n700  azulo centrar">
                        <h1><b>Sistema de Informaci&oacute;n para el Restablecimiento de Derechos de Ni&ntilde;os, Ni&ntilde;as y Adolescentes
                            </b></h1>
                    </div>
                </div>
        ...
        <div class="container ps ">
            <div class="row clearfix centrar">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 ">
                    <h2 class="centrar letra n600 azulo pi">Ni&ntilde;os y Ni&ntilde;as o Adolescentes
                        NNA</h2>
                </div>
            </div>
        </div>
            ...
            <div class="row clearfix centrar">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 ">
                    <ul class="nav nav-tabs">
                        ...
                        <li role="presentation" class="letra n500"></li>
                        <li role="presentation" class="letra n500"><a href="ConsultarNNA.php" target="usuario">Consultar NNA</a></li>
    ...
    <iframe name="usuario" src="ConsultarNNA.php" width="100%" height="0" frameborder="0" transparency="transparency" onload="autofitIframea(this);" scrolling="no"></iframe>
