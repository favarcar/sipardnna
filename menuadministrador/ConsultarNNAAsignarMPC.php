    ...
    <?php
                  ...
                  <div class="table-responsive">
                    <table class="table table-striped table-bordered">
                        ...
                        <tbody>
                        <?php $busqueda = mysqli_query($con,"SELECT * FROM ninnosnna  WHERE id_municipio_hechos ='$id_municipio' ORDER BY Apellidos DESC " ); //cambiar nombre de la tabla de busqueda
