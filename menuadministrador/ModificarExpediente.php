    ...
    <div class="container pi3x">
      ...
      <form class="form-horizontal ps2x" method="post" enctype="multipart/form-data">
        <fieldset>
          ...
          <div class="form-group">
            <label class="col-md-4 control-label letra n600 azulo" for="textinput">Nombre de Ni&ntilde;o, Ni&ntilde;a o
              Adolescente
            </label>
            <div class="col-md-4">
          ...
          <div class="form-group">
            <label class="col-md-4 control-label letra n600 azulo" for="textinput">No. de Documento de Ni&ntilde;o, Ni&ntilde;a o
              Adolescente
            </label>
            <div class="col-md-4">
          ...
          <div class="form-group">
            ...
            <div class="col-md-4">
              <?php $busqueda1 = mysqli_query($con, "SELECT * FROM discapacidades where id_discapacidad='$id_discapacidad' ");
              while ($row1 = mysqli_fetch_array($busqueda1)) {
              ...
              <select name="discapacidad_exp" id="discapacidad_exp" disabled class="form-control" style="text-transform: uppercase;">
                ...
                <?php
                $con2 = mysqli_query($con, "select * from  discapacidades");
                $reg = mysqli_fetch_array($con2);
                do {
                  $id_discapacidad = $reg['id_discapacidad'];
                  $des_discapacidad = $reg['descripcion_discapacidades'];
                ?>
                  <option value="<?php echo $id_discapacidad; ?>"><?php echo $des_discapacidad; ?> </option>
                <?php
          ...
          <div class="form-group">
            ...
            <div class="col-md-4">
              <?php $busqueda1 = mysqli_query($con, "SELECT * FROM indicadores where id_indicador='$id_indicador' ");
              $des_indicador = "";
              while ($row1 = mysqli_fetch_array($busqueda1)) {
              ...
              ?>
              <select name="indicadores_exp" id="discapacidad_exp" disabled class="form-control" style="text-transform: uppercase;">
                <option value="<?php echo $id_indicador ?>"><?php echo $des_indicador ?></option>
                <?php
                $con3 = mysqli_query($con, "select * from  indicadores");
          ...
          <div class="form-group">
            ...
            <div class="col-md-4">
              ...
              <?php $busqueda1 = mysqli_query($con, "SELECT * FROM maltratos where id_maltrato='$id_maltrato' ");
              while ($row1 = mysqli_fetch_array($busqueda1)) {
              ...
              <select name="maltratos_exp" id="maltratos_exp" disabled class="form-control" style="text-transform: uppercase;">
                ...
                <?php
                $con4 = mysqli_query($con, "select * from  maltratos");
          ...
          <div class="form-group">
            ...
            <div class="col-md-4">
              ...
              <select name="victima_exp" id="victima_exp" disabled class="form-control" style="text-transform: uppercase;">
                ...
                <?php
                $con5 = mysqli_query($con, "select * from  victimas");
                $reg = mysqli_fetch_array($con5);
                do {
                ...
                ?>
                  <option value="<?php echo $id_victima; ?>"><?php echo $des_victima; ?> </option>
                <?php
                } while ($reg = mysqli_fetch_array($con5));
                ?>
          ...
          <div class="form-group">
            ...
            <div class="col-md-4">
              ...
              <?php $busqueda1 = mysqli_query($con, "SELECT * FROM entidades where id_entidad='$id_entidad' ");
              while ($row1 = mysqli_fetch_array($busqueda1)) {
              ...
              <select name="entidad_exp" id="entidad_exp" disabled class="form-control" style="text-transform: uppercase;">
                ...
                <?php
                $con6 = mysqli_query($con6, "select * from  entidades");
                $reg = mysqli_fetch_array($con6);
                do {
                ...
                ?>
                  <option value="<?php echo $id_entidad; ?>"><?php echo $des_entidad; ?> </option>
                <?php
                } while ($reg = mysqli_fetch_array($con6));
                ?>
          ...
          <div class="form-group">
            ...
            <div class="col-md-4">
              ...
              <select name="estadocaso_exp" id="estadocaso_exp" disabled class="form-control" style="text-transform: uppercase;">
                ...
                <?php
                $con7 = mysqli_query($con, "select * from  estado_caso");
                $reg = mysqli_fetch_array($con7);
                do {
                ...
                ?>
                  <option value="<?php echo $id_estadocaso; ?>"><?php echo $des_estadocaso; ?> </option>
                <?php
                } while ($reg = mysqli_fetch_array($con7));
                ?>
